...
<table id='layoutEditorButtons' cellspacing='2'>
    <tr>
        ...
        {if $view == 'editview'}
            <td>
                <input id="historyBtn" type="button" valign="center" class="button" style="cursor:pointer"
                       onmousedown="this.className='buttonOn';return false;"
                       onmouseup="this.className='button'" onmouseout="this.className='button'"
                       onclick="ModuleBuilder.customHideLogic.browse('{$view_module}', 'editview')"
                       value="Custom hide logic">
                <input type="checkbox" {if $syncDetailEditViews}checked="true"{/if} id="syncCheckbox"
