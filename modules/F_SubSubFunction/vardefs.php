...
$dictionary['F_SubSubFunction'] = array(
    'table' => 'f_subsubfunction',
    'audited' => true,
    'inline_edit' => true,
...
VardefManager::createVardef('F_SubSubFunction', 'F_SubSubFunction', array('basic','assignable','security_groups'));