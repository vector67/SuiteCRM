...
$mod_strings = array (
  ...
  'LBL_HOMEPAGE_TITLE' => 'My NNB',
  'LNK_NEW_RECORD' => 'Create NNB',
  'LNK_LIST' => 'View NNB',
  'LNK_IMPORT_NNB_NNB' => 'Import NNB',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
  'LBL_NNB_NNB_SUBPANEL_TITLE' => 'NNB',
  'LBL_CLIENT_NAME' => 'Client name',
  'LBL_NNB_REFERRAL_TRIGGER' => 'NNB Referral Trigger',
  'LBL_FUNDING_AGENCY' => 'Funding Agency /Principal (if different  from the Client) ',
  'LBL_OPPORTUNITY_SPEND ' => 'Opportunity Spend (Budget)',
  'LBL_PARTNERS' => 'Consulting Partners',
  'LBL_PROJECT_VALUE' => 'Project value',
  'LBL_PROCUREMENT_TYPE' => 'Procurement Type',
  'LBL_JV_REVENUE' => 'JV Revenue (if applicable)',
  'LBL_CONTRACT_DURATION' => 'Contract duration',
  'LBL_TENDER_COSTS' => 'Expected Tender costs',
  'LBL_PAYMENT_TERMS' => 'Payment terms',
  'LBL_SCOPE_OF_SERVICES' => 'Scope of Services',
  'LBL_RISKS' => 'Risks & Opportunities',
  'LBL_CASHFLOW_FORECAST' => 'For NNB due to cash-flow negative  criteria, provide cash-flow forecast.',
  'LBL_RISK_MANAGEMENT' => 'Intended means of managing the  particular risks arising from the NNB  circumstances (e.g. uncapped liability) ',
  'LBL_OTHER_INFO' => 'Other relevant information ',
  'LBL_PROPOSAL_MANAGER' => 'Proposal Manager',
  'LBL_EDITVIEW_PANEL1' => 'Audit tracking',
  'LBL_PI_INSURANCE' => 'Pi insurance',
  'LBL_SMEC_REVENUE' => 'Expected SMEC revenue',
  'LBL_PROPOSED_PAYMENT_TERMS' => 'Proposed payment terms',
);