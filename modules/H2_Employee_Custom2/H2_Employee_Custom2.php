...
class H2_Employee_Custom2 extends Person
{
    public $new_schema = true;
    public $module_dir = 'H2_Employee_Custom2';
    public $object_name = 'H2_Employee_Custom2';
    public $table_name = 'h2_employee_custom2';
